...
/** @typedef {{baseUrl: string, filename: string}} ParsedImage */

const ImageWrapper = React.forwardRef(
  /** @param {{aspectRatio?: string, className?: string, style?: any, children?: any}} props @param {import('react').Ref<any>} ref */
...
const ResponsiveImage = React.forwardRef(
  /**
   * @param {{parsed?: ParsedImage, fittingType?: string, focalPoint?: {x:number,y:number}, quality?: number, className?: string, style?: any, aspectRatio?: string, onLoad?: (e:any)=>void}} props
   * @param {import('react').Ref<any>} parentRef
   */
...
const Image = React.forwardRef(
  (
    /** @param {{src?: string, fittingType?: string, originWidth?: number, originHeight?: number, focalPointX?: number, focalPointY?: number, quality?: number, onError?: (e:any)=>void}} */
    {
      src,
      fittingType = "fill",
      originWidth,
